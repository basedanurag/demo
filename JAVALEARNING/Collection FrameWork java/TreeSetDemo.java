...
public class TreeSetDemo {
    public static void main(String[] args) {
        ...
        System.out.println(ts.ceiling(19));// if the entered number is not present then  this method gives the greater closest number than element inside the HashSet;
